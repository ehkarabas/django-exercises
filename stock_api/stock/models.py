...
class Brand(FixModel):
    ...
    image = models.URLField(blank=True, null=True) # ImageField yerine URLField kullanilmistir cunku image URL olarak saklanacaktir.
...
class Purchase(FixModel):
    ...
    # insert/update:
    # env\Lib\site-packages\django\db\models\base.py Model save method'u override ediliyor
    def save(self, *args, **kwargs):
        # yeni kayitta bir id olmaz, id kayittan sonra gerceklesir, bu mantikla algoritma kuruluyor
        if (self.id): # update
    ...
    # delete:
    # env\Lib\site-packages\django\db\models\base.py Model delete method'u override ediliyor
...
class Sale(FixModel):
    ...
    def save(self, *args, **kwargs):        
        ...
        # Ürün getir:
        product = Product.objects.get(id=self.product_id)
        # Stokta yeteri kadar yoksa satış yapma(admin panel icin):
        # Miktar yeterli mi?
